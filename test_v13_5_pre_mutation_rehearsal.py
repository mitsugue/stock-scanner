...
def prepare(tmp_path, monkeypatch):
    ...
    (dist / "index.html").write_text(
        '<script>globalThis.__ARGUS_VERSION__="13.5.58";'
        'globalThis.__ARGUS_PRODUCT_VERSION__="v13.5.58";'
    ...
    write_json(repo / "web/package.json", {"version": "13.5.58"})
    write_json(repo / "backend-version.json", {"version": "13.5.58"})
